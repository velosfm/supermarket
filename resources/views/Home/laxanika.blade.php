  ...
  <div class="row justify-content-md-center">
            ...
            <ul class="list-group w-50 mx-auto">
             ...
             <li class="list-group-item" style="background: #afb9c7; text-align: center;">
                ...
                <div class="col-sm-4">
                  ...
                  @if(empty($prod['IMAGE']))       
            <img src="{{$basket_data['base_url']}}default_kalathi.png" class="img-thumbnail" width="100px">
                   @else
        ...
        <div class="col-sm-8">
            <ul class="list-group" style="background: #dee9f3;">
                ...
                <li class="prod-list" style="font-weight: bold;">Ελάχιστη Τιμή: {{$prod['PRICE_MIN']}} €</li>
                <li class="prod-list"style="font-weight: bold;">Μέγιστη Τιμή: {{$prod['PRICE_MAX']}} €</li>
            </ul>
        </div>
    </div>
           </li>        

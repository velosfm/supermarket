  ...
  <div class="row justify-content-md-center">
        ...
        <div class="col-sm-8">
            <ul class="list-group" style="background: #dee9f3;">
                ...
                <li class="prod-list" style="font-weight: bold;">Τιμή: <?php echo e($prod['PRICE']); ?> €</li>
                <li class="prod-list"style="font-weight: bold;">Τιμή/<?php echo e($prod['UNIT']); ?>: <?php echo e($prod['PRICE_NORMALIZED']); ?> €</li>
            </ul>
        </div>
    </div>
           </li>        
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\supermarket\resources\views/Home/kalathi.blade.php ENDPATH**/ ?>